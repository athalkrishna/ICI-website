...
const STATIC_PAGES: SeedPage[] = [
  ...
  page('/faculty', 'Faculty', 'Faculty and research page', [
    ...
    f('research_heading', 'Research Heading', T.TEXT, 'Our approach to research and thinking', 'Research', 15),
    f('research_body', 'Research Body', T.TEXTAREA, 'Coaching deserves rigour. We draw on coaching psychology, behavioural science and neuroscience, test ideas against real practice, and share what we learn through articles and teaching.', 'Research', 16),
    f('themes_heading', 'Themes Heading', T.TEXT, 'Themes we explore', 'Research', 17),
    f('theme_1', 'Theme 1', T.TEXTAREA, 'The inner life of high achievers, including the loneliness of success', 'Research', 18),
    f('theme_2', 'Theme 2', T.TEXTAREA, 'How change really happens in the brain and the nervous system', 'Research', 19),
    f('theme_3', 'Theme 3', T.TEXTAREA, 'Leadership as a practice of self-mastery', 'Research', 20),
    f('theme_4', 'Theme 4', T.TEXTAREA, 'Defence mechanisms, projection and the patterns that shape behaviour', 'Research', 21),
    f('theme_5', 'Theme 5', T.TEXTAREA, 'Contemplative traditions and modern behavioural science in dialogue', 'Research', 22),
  ...
  page('/about/accreditation', 'Accreditation', 'About accreditation page', [
    f('hero_eyebrow', 'Hero Eyebrow', T.TEXT, 'Recognition & Accreditation', 'Hero', 1),
    f('hero_heading', 'Page Heading', T.TEXT, 'Standards you can stand behind', 'Hero', 2),
    f('hero_body', 'Page Introduction', T.RICHTEXT, '<p>A credential is only worth what it can be trusted to mean. This page sets out how ICI holds its standard, the bodies it works with, and the recognition behind its credentials, stated plainly and only where it is genuinely earned.</p>', 'Hero', 3),
    f('standards_heading', 'Standards Section Heading', T.TEXT, 'How we hold our standard', 'Standards', 5),
    f('standard_1', 'Standard Point 1', T.TEXTAREA, 'Every level is assessed on real coaching, not attendance', 'Standards', 6),
    f('standard_2', 'Standard Point 2', T.TEXTAREA, 'Faculty are practising coaches held to a professional code', 'Standards', 7),
    f('standard_3', 'Standard Point 3', T.TEXTAREA, 'Curriculum aligned to international coaching competency standards', 'Standards', 8),
    f('standard_4', 'Standard Point 4', T.TEXTAREA, 'Independent review of our assessment process', 'Standards', 9),
    f('accreditations_heading', 'Accreditations Heading', T.TEXT, 'Recognition & professional bodies', 'Accreditations', 10),
    f('accreditations_intro', 'Accreditations Intro', T.TEXTAREA, 'We work with and align to recognised professional bodies where it genuinely applies to our programmes.', 'Accreditations', 11),
    f('accreditation_1_name', 'Accreditation 1 Name', T.TEXT, 'ICF', 'Accreditations', 12),
    ...
    f('accreditation_5_description', 'Accreditation 5 Description', T.RICHTEXT, '<p>Quality management system certification for our training operations.</p>', 'Accreditations', 20),
    f('cta_link_1_text', 'CTA 1 Text', T.TEXT, 'See the Mastery Pathway', 'CTA', 30),
    f('cta_link_1_url', 'CTA 1 URL', T.URL, '/credentials', 'CTA', 31),
    f('cta_link_2_text', 'CTA 2 Text', T.TEXT, 'Contact us', 'CTA', 32),
    f('cta_link_2_url', 'CTA 2 URL', T.URL, '/admissions/contact', 'CTA', 33),
    codeField(999),
  ]),
  page('/about/mission', 'Mission', 'About mission page', [
    ...
    f('value_title_1', 'Value 1 Title', T.TEXT, 'Depth over performance', 'Values', 20),
    f('value_desc_1', 'Value 1 Description', T.TEXTAREA, 'We prize real understanding of people over polished technique.', 'Values', 21),
    f('value_title_2', 'Value 2 Title', T.TEXT, 'Evidence with humanity', 'Values', 22),
    f('value_desc_2', 'Value 2 Description', T.TEXTAREA, 'We teach what the science supports, in language that respects the person in front of you.', 'Values', 23),
    f('value_title_3', 'Value 3 Title', T.TEXT, 'Practice, not theory', 'Values', 24),
    f('value_desc_3', 'Value 3 Description', T.TEXTAREA, 'Every concept is tied to what happens in a real session.', 'Values', 25),
    f('value_title_4', 'Value 4 Title', T.TEXT, 'Self-mastery first', 'Values', 26),
    f('value_desc_4', 'Value 4 Description', T.TEXTAREA, 'A coach can only take a client as far as they have gone themselves.', 'Values', 27),
    codeField(999),
  ]),
  ...
  simpleHeroPage(
    ...
    [
      ...
      f('cta_link_1_text', 'CTA 1 Text', T.TEXT, 'Explore the Mastery Pathway', 'CTA', 20),
      f('cta_link_1_url', 'CTA 1 URL', T.URL, '/credentials', 'CTA', 21),
      f('cta_link_2_text', 'CTA 2 Text', T.TEXT, 'Speak to an advisor', 'CTA', 22),
      f('cta_link_2_url', 'CTA 2 URL', T.URL, '/contact', 'CTA', 23),
      f('cta_heading', 'CTA Heading', T.TEXT, 'Meet our faculty', 'CTA', 24),
  ...
  page('/about/press', 'Press & Media', 'Press and media enquiries', [
    ...
    f('press_kit_item_1', 'Press Kit Item 1', T.TEXT, 'Logo & Brand Guidelines', 'Press Kit', 22),
    f('press_kit_type_1', 'Press Kit Item 1 Type', T.TEXT, 'ZIP', 'Press Kit', 23),
    f('press_kit_item_2', 'Press Kit Item 2', T.TEXT, 'Institute Fact Sheet', 'Press Kit', 24),
    f('press_kit_type_2', 'Press Kit Item 2 Type', T.TEXT, 'PDF', 'Press Kit', 25),
    f('press_kit_item_3', 'Press Kit Item 3', T.TEXT, 'Approved Descriptions', 'Press Kit', 26),
    f('press_kit_type_3', 'Press Kit Item 3 Type', T.TEXT, 'PDF', 'Press Kit', 27),
    f('media_enquiries_heading', 'Media Enquiries Heading', T.TEXT, 'Media Enquiries', 'Contact', 30),
    f('media_email_label', 'Media Email Label', T.TEXT, 'Email us', 'Contact', 31),
    f('topics_heading', 'Topics Heading', T.TEXT, 'Topics our faculty can speak to', 'Topics', 40),
    f('topics_body', 'Topics Body', T.TEXTAREA, 'Coaching, leadership, the psychology of high achievers, and how people actually change.', 'Topics', 41),
    f('cta_button_text', 'CTA Button Text', T.TEXT, 'Contact media team', 'CTA', 50),
    f('cta_button_link', 'CTA Button Link', T.URL, '/contact', 'CTA', 51),
    codeField(999),
  ]),
