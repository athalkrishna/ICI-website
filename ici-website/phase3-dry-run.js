...
fs.writeFileSync('phase3-dry-run-output.txt', diffs.join('\n'));
console.log('Phase 3 Dry run complete. Found ' + matchedCount + ' matches across ' + phase3Patterns.length + ' long-tail patterns.');
