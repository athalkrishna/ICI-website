        ...
        <div className="max-w-[1440px] mx-auto px-4 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-32">
            <AnimatedSection className="space-y-8">
              <div className="w-20 h-20 bg-gold-50 rounded-2xl flex items-center justify-center mb-8 border border-gold-100">
                <ShieldCheck className="w-10 h-10 text-gold-500" />
              </div>
              <h2 className="font-display text-4xl font-bold text-navy-800">A credential is only worth what it can be trusted to mean.</h2>
            ...
            <AnimatedSection delay={0.2}>
              <div className="bg-white p-10 lg:p-14 rounded-3xl shadow-xl shadow-navy-900/5 border border-gray-100 relative overflow-hidden">
                ...
                <h3 className="font-display text-2xl font-bold text-navy-800 mb-10">How we hold our standard</h3>
                ...
                <div className="space-y-8">
                  {[
                    ...
                    <div key={i} className="flex gap-6 items-start group">
                      <div className="w-12 h-12 bg-cream-50 rounded-xl flex items-center justify-center shrink-0 text-gold-500 group-hover:bg-gold-500 group-hover:text-white transition-colors">
                        {item.icon}
                      </div>
