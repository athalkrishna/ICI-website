        ...
        <div className="max-w-[1440px] mx-auto px-4 lg:px-8 relative z-20">
          <AnimatedSection className="max-w-3xl">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div className="font-sans text-sm font-bold uppercase tracking-[0.2em] text-gold-400">Press & Media</div>
            </div>
                  ...
                  {[
                    ...
                    <div key={i} className="flex items-center justify-between p-6 rounded-2xl border border-gray-100 hover:border-gold-300 hover:bg-gold-50/30 transition-all group cursor-pointer">
                      <div className="flex items-center gap-5">
                        ...
                        <div>
                          <div className="font-body font-bold text-navy-800 text-lg mb-1 group-hover:text-gold-700 transition-colors">{asset.title}</div>
                          <div className="font-sans text-xs uppercase tracking-wider text-gray-400">{asset.type}</div>
                        </div>
                      </div>
                      <div className="w-10 h-10 rounded-full bg-cream-100 flex items-center justify-center text-navy-600 group-hover:bg-gold-500 group-hover:text-white transition-colors shadow-sm">
                        <Download size={18} />
                      </div>
                    </div>
                  ))}
