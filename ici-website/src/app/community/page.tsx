  ...
  return (
    <div className="bg-cream-50 min-h-screen font-sans selection:bg-brand-gold-500/30">
        ...
        <Container className="relative z-20">
          <AnimatedSection className="max-w-4xl">
            <div className="flex items-center gap-6 mb-8">
              ...
              <div className="text-eyebrow text-brand-gold-400">Community</div>
            </div>
      ...
      <Section spacing="standard" className="relative z-20">
        <Container>
          <AnimatedSection>
            <h2 className="text-h2 text-brand-navy-900 mb-12">What the community offers</h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                <div key={i} className="bg-white border border-navy-100 shadow-sm p-8 rounded-[24px] hover:border-brand-gold-500 hover:shadow-md transition-all">
                  ...
                  <h3 className="font-sans text-h3 text-brand-navy-900 leading-snug">{item.title}</h3>
                </div>
              ))}
            </div>
          </AnimatedSection>
      ...
      <Section spacing="standard" className="bg-cream-50 border-t border-navy-100 relative z-20">
        <Container>
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
            ...
            <AnimatedSection>
              <h2 className="text-h2 text-brand-navy-900 mb-6">Alumni network</h2>
            ...
            <AnimatedSection delay={0.1}>
              <h2 className="text-h2 text-brand-navy-900 mb-6">Membership and continuing development</h2>
              <p className="text-muted mb-8 text-body">
