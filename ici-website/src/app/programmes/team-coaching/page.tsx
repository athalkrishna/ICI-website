        ...
        <Container className="relative z-20">
          <AnimatedSection className="max-w-4xl">
            <div className="flex items-center gap-6 mb-8">
              ...
              <div className="text-eyebrow text-brand-gold-400">Specialisation | Team & Organisational</div>
            </div>
            ...
            <div className="bg-brand-navy-900 p-10 md:p-16 lg:p-20 border-brand-gold-500/20 relative overflow-hidden rounded-[32px] shadow-2xl border border-navy-100">
              ...
              <Container size="narrow" className="relative z-10">
                ...
                <div className="flex flex-col md:flex-row items-center gap-4 w-full">
                  <Link href="/admissions/contact" className="btn-primary w-full md:w-auto justify-center">
