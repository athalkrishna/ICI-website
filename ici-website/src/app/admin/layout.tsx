...
export default function AdminLayout({ children }: { children: ReactNode }) {
  return (
    <div className="flex min-h-screen bg-cream-50 text-navy-900 font-sans">
      <aside className="w-64 bg-brand-navy-900 text-white flex-shrink-0">
        <div className="p-6">
          <h1 className="text-h1 font-bold font-display tracking-wide text-brand-gold-400">ICI Admin</h1>
        </div>
        <nav className="mt-6">
          <ul className="space-y-2 px-4">
            ...
            <li><Link href="/admin" className="block py-2 px-3 rounded hover:bg-brand-navy-800 transition">Site Settings</Link></li>
          </ul>
        </nav>
      </aside>
