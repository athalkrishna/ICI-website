      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <AnimatedSection delay={0.1}>
            <div className="bg-cream-50 p-8 rounded-2xl h-full border border-navy-100">
              <h3 className="text-h3 text-brand-navy-700 mb-4">Upcoming Events</h3>
              <ul className="space-y-4">
                 {[1, 2].map((i) => (
                   <li key={i} className="flex gap-4 border-b border-navy-200 pb-4 last:border-0 last:pb-0">
                     <div className="bg-white px-4 py-2 rounded shadow-sm text-center border border-navy-100">
          ...
          <AnimatedSection delay={0.2}>
            <div className="bg-cream-50 p-8 rounded-2xl h-full border border-navy-100">
              ...
              <ul className="space-y-4">
                {[1, 2].map((i) => (
                  <li key={i} className="border-b border-navy-200 pb-4 last:border-0 last:pb-0">
                     <div className="text-xs font-sans text-navy-400 mb-1">August 12, 2026</div>
