        ...
        <div className="flex flex-wrap justify-center items-center gap-8 md:gap-20 text-navy-400 opacity-60 hover:opacity-100 transition-opacity duration-500">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col text-left">
              ...
              <span className="font-sans text-xs text-muted uppercase tracking-widest leading-none mt-1.5">Accredited</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col text-left">
              ...
              <span className="font-sans text-xs text-muted uppercase tracking-widest leading-none mt-1.5">Global Standard</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col text-left">
              ...
              <span className="font-sans text-xs text-muted uppercase tracking-widest leading-none mt-1.5">Association</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col text-left">
              ...
              <span className="font-sans text-xs text-muted uppercase tracking-widest leading-none mt-1.5">Approved Provider</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col text-left">
              ...
              <span className="font-sans text-xs text-muted uppercase tracking-widest leading-none mt-1.5">9001:2015</span>
            </div>
          </div>
        </div>
        */}
