...
export default function BlogPostCard({ post, excerptOverride }: BlogPostCardProps) {
    ...
    <article className="ici-card relative flex flex-col h-full bg-white group border border-navy-100 overflow-hidden">
      ...
      <Link href={`/blog/${post.slug}`} className="flex flex-col h-full">
        ...
        <div className="p-6 sm:p-8 flex-1 flex flex-col">
          ...
          <p className="text-brand-navy-600 text-base sm:text-lg leading-relaxed mb-6 flex-1 line-clamp-3">
            {excerpt}
          </p>
