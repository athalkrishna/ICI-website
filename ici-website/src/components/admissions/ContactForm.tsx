      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="space-y-2">
          ...
          <input 
            ...
            id="name" 
            {...register('name')}
            className="w-full bg-white/5 border border-white/10 hover:bg-white/10 rounded-xl px-4 py-3.5 text-white placeholder:text-white/40 focus:outline-none focus:ring-2 focus:ring-gold-500/50 focus:border-gold-500/50 transition-all font-body min-h-[44px]"
